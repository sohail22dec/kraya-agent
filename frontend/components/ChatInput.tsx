...
export function ChatInput({ onSend, onStop, isStreaming, disabled }: ChatInputProps) {
    ...
    return (
        <div className="px-4 md:px-8 py-4 border-t border-white/[0.05] bg-[#111111]">
            <div className="max-w-3xl mx-auto">
                ...
                <p className="text-center text-[11px] text-white/20 mt-2">
                    Press <kbd className="px-1 py-0.5 rounded bg-white/[0.06] text-white/30 text-[10px]">Enter</kbd> to send ·{" "}
                    <kbd className="px-1 py-0.5 rounded bg-white/[0.06] text-white/30 text-[10px]">Shift+Enter</kbd> for new line
                </p>
            </div>
        </div>
    );
