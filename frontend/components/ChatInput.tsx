  ...
  return (
    <div className="px-4 md:px-8 py-4">
      <div className="max-w-3xl mx-auto">
        <div
          className={cn(
            "relative flex items-end gap-2 rounded-2xl border bg-white/[0.03] transition-all duration-200",
            isStreaming
        ...
        >
          ...
          <textarea
            ...
            rows={1}
            disabled={disabled}
            className="flex-1 resize-none bg-transparent pl-4 py-3.5 text-[15px] text-white/85 placeholder:text-white/25 focus:outline-none leading-relaxed disabled:opacity-50 max-h-[200px] overflow-y-auto scrollbar-thin"
          />
